    ...
    return (
      <div className={classNames(styles['deployment-table'], this.props.className)}>
        ...
        { this.props.data.length === 0 && !this.props.loading ?
          (<div style={{padding: '3% 20%', color: '#797979'}}>To work with this application, you need to have online deployment of Best Heart Drug Selection model created in your WML service instance.
          For more information check application <a href='https://github.com/pmservice/best-heart-drug-selection/blob/master/README.md' target='_blank'>readme</a>.</div>) : null
        }
      </div>
    );
  }
